  ...
  return (
    <div className="user-container">
      <div className="dflex justify-content-between">
        {isEditing && <h2>Editar usuário</h2>}
        {isDetails && <h2>Detalhes do usuário</h2>}
        {!isEditing && !isDetails && <h2>Cadastrar usuário</h2>}
      </div>
        ...
        <div>
          ...
          >
                    ...
                    ({ getFieldValue }) => ({
                      validator(_, value) {
                        ...
                        return Promise.reject(
                          new Error("Senhas não são iguais!")
                        );
                      },
                    }),
                  ]}
            ...
            <div className="dflex justify-content-between">
              ...
              <Form.Item style={{ width: "29%" }} name="sexo" label="Sexo">
                <Select
                  style={{ width: "100%" }}
                  options={[
            ...
            <div className="dflex justify-space-between">
              <Form.Item name="cep" style={{ width: "20%" }} label="CEP">
                <Input style={{ width: "100%" }} />
              </Form.Item>
              <Form.Item
                name="rua"
            ...
            <div className="dflex">
              <Form.Item name="numero" style={{ width: "20%" }} label="Número">
                <Input />
              </Form.Item>
              <Form.Item
                name="complemento"
            ...
            <div className="dflex justify-content-between">
              <Form.Item name="bairro" style={{ width: "32%" }} label="Bairro">
                <Input />
              </Form.Item>
              <Form.Item name="cidade" style={{ width: "32%" }} label="Cidade">
                <Input />
              </Form.Item>
              <Form.Item name="estado" style={{ width: "32%" }} label="Estado">
                <Input />
              </Form.Item>
            </div>
            {!isDetails && (
